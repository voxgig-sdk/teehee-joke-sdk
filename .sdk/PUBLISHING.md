...
|---|---|---|
| `ts/` | @voxgig-sdk/teehee-joke-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/teehee-joke-sdk \
      --repository voxgig-sdk/teehee-joke-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/teehee-joke-sdk` shows it, and
`npm trust revoke @voxgig-sdk/teehee-joke-sdk --id=<id>` removes it.
