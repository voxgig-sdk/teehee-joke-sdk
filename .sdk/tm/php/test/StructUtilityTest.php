...
// TeeheeJoke SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = TeeheeJokeOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(TeeheeJokeOmni::structfix($now, Struct::undef()))
                        !== json_encode(TeeheeJokeOmni::structfix($val, Struct::undef()))) {
