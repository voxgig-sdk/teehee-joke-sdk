...
// TeeheeJoke SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class TeeheeJokeMakeRequest
{
    public static function call(TeeheeJokeContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new TeeheeJokeResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new TeeheeJokeResponse($fetched);
        } else {
