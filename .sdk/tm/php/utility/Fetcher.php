...
// TeeheeJoke SDK utility: fetcher

class TeeheeJokeFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; TeeheeJokeSDK/1.0)';
    ...
    public static function call(TeeheeJokeContext $ctx, string $fullurl, array $fetchdef): array
    {
