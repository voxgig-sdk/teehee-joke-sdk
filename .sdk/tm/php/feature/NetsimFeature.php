...
class TeeheeJokeNetsimFeature extends TeeheeJokeBaseFeature
{
    ...
    private function _simulate(TeeheeJokeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(TeeheeJokeContext $ctx, array $applied): void
    {
        $client = $this->client;
