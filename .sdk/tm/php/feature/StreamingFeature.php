...
// TeeheeJoke SDK streaming feature
...
class TeeheeJokeStreamingFeature extends TeeheeJokeBaseFeature
{
    ...
    private function _iterate(TeeheeJokeResult $result): \Generator
    {
    ...
    private function _streamable(TeeheeJokeContext $ctx): bool
    {
