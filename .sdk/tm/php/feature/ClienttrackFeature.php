...
// TeeheeJoke SDK clienttrack feature
...
class TeeheeJokeClienttrackFeature extends TeeheeJokeBaseFeature
{
    ...
    public function PostConstruct(TeeheeJokeContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'TeeheeJoke-SDK';
