...
// TeeheeJoke SDK ratelimit feature
...
class TeeheeJokeRatelimitFeature extends TeeheeJokeBaseFeature
{
    ...
    private function _acquire(TeeheeJokeContext $ctx): void
    {
    ...
    private function _track(TeeheeJokeContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
