...
class TeeheeJokeProxyFeature extends TeeheeJokeBaseFeature
{
    ...
    public function init(TeeheeJokeContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (TeeheeJokeContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
