...
class TeeheeJokeRbacFeature extends TeeheeJokeBaseFeature
{
    ...
    private function _required(TeeheeJokeContext $ctx): ?string
    {
    ...
    private function _reject(TeeheeJokeContext $ctx, string $required): void
    {
    ...
    private function _track(TeeheeJokeContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
