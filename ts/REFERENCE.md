# TeeheeJoke TypeScript SDK Reference

Complete API reference for the TeeheeJoke TypeScript SDK.
...
```ts
new TeeheeJokeSDK(options?: object)
```
...
#### `TeeheeJokeSDK.test(testopts?, sdkopts?)`
...
**Returns:** `TeeheeJokeSDK` instance in test mode.
...
Return the parent `TeeheeJokeSDK` instance.
