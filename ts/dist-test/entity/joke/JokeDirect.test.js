...
(0, node_test_1.describe)('JokeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.TeeheeJokeSDK({
    ...
    (0, node_test_1.test)('direct-load-joke', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-joke', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.TEEHEE_JOKE_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.TeeheeJokeSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['TEEHEE_JOKE_TEST_JOKE_ENTID'];
    ...
    const client = new __1.TeeheeJokeSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=JokeDirect.test.js.map