...
function envOverride(m) {
    if ('TRUE' === process.env.TEEHEE_JOKE_TEST_LIVE ||
        'TRUE' === process.env.TEEHEE_JOKE_TEST_OVERRIDE) {
    ...
    m.TEEHEE_JOKE_TEST_EXPLAIN = process.env.TEEHEE_JOKE_TEST_EXPLAIN || m.TEEHEE_JOKE_TEST_EXPLAIN;
    return m;
}
