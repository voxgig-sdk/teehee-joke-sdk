# TeeheeJoke TypeScript SDK



The TypeScript SDK for the TeeheeJoke API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.Joke()` — each with a small set of operations (`load`)
...
| `tester(testopts?, sdkopts?)` | `TeeheeJokeSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `TeeheeJokeSDK.test(testopts?, sdkopts?)` | `TeeheeJokeSDK` | Create a test-mode client. |
...
| `client` | `client(): TeeheeJokeSDK` | Return the parent SDK client. |
...
teehee-joke/
├── src/
│   ├── TeeheeJokeSDK.ts        # Main SDK class
