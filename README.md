...
The Teehee.dev API provides a simple way to retrieve random jokes curated by Jesse G.

Learn more about Teehee Joke API at [teehee.dev](https://teehee.dev/).
...
// joke is the Joke entity, populated with mock data
