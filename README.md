...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/teehee-joke` | `npm install @voxgig-sdk/teehee-joke` |
| Python | `voxgig-sdk-teehee-joke` | `pip install voxgig-sdk-teehee-joke` |
| PHP | `voxgig-sdk/teehee-joke` | `composer require voxgig-sdk/teehee-joke` |
| Golang | `github.com/voxgig-sdk/teehee-joke-sdk/go` | `go get github.com/voxgig-sdk/teehee-joke-sdk/go` |
| Ruby | `voxgig-sdk-teehee-joke` | `gem install voxgig-sdk-teehee-joke` |
| Lua | `voxgig-sdk-teehee-joke` | `luarocks install voxgig-sdk-teehee-joke` |
