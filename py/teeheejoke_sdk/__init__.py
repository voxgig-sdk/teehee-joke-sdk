...
from teeheejoke_sdk.utility import register

# Load features
from teeheejoke_sdk.feature.base_feature import TeeheeJokeBaseFeature
from teeheejoke_sdk.features import _has_feature, _make_feature
...
class TeeheeJokeSDK:
    ...
    def get_utility(self):
        return TeeheeJokeUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("TeeheeJokeSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Joke(self, data=None) -> "JokeEntity":
        ...
        from teeheejoke_sdk.entity.joke_entity import JokeEntity
