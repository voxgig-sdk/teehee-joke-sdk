...
from teeheejoke_sdk.core.control import TeeheeJokeControl
...
from teeheejoke_sdk.core.helpers import get_ctx_prop, to_map
...
class TeeheeJokeContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, TeeheeJokeSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, TeeheeJokeResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, TeeheeJokeResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return TeeheeJokeError(code, msg, self)
