# TeeheeJoke Python SDK Reference

Complete API reference for the TeeheeJoke Python SDK.
...
```python
from teehee-joke_sdk import TeeheeJokeSDK
...
#### `TeeheeJokeSDK.test(testopts=None, sdkopts=None)`
