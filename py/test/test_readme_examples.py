# TeeheeJoke SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions TeeheeJokeSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both TeeheeJokeSDK(...) and TeeheeJokeSDK.test(...) become
#      TeeheeJokeSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "teeheejoke_sdk"
_SDK_CLASS = "TeeheeJokeSDK"
