...
class TeeheeJokeTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = TeeheeJokeTestRunner.getenv("TEEHEEJOKE_TEST_LIVE")
        override = TeeheeJokeTestRunner.getenv("TEEHEEJOKE_TEST_OVERRIDE")
        ...
        explain = TeeheeJokeTestRunner.getenv("TEEHEEJOKE_TEST_EXPLAIN")
        if explain is not None and explain != "":
            m["TEEHEEJOKE_TEST_EXPLAIN"] = explain
