# TeeheeJoke Python SDK



The Python SDK for the TeeheeJoke API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Joke()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/teehee-joke-sdk/releases)) or
...
```
py/
├── teeheejoke_sdk.py         -- Main SDK module
