...
// TeeheeJoke SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (TeeheeJokeSDK::test)
...
{
    private const SDK_CLASS = 'TeeheeJokeSDK';
    ...
    private const SDK_BASE = 'teeheejoke_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../teeheejoke_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
