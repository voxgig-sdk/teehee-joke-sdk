...
// TeeheeJoke SDK telemetry feature
...
class TeeheeJokeTelemetryFeature extends TeeheeJokeBaseFeature
{
    ...
    private function _close(TeeheeJokeContext $ctx, bool $ok): void
    {
