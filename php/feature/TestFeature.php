...
// TeeheeJoke SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class TeeheeJokeTestFeature extends TeeheeJokeBaseFeature
{
    ...
    public function init(TeeheeJokeContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (TeeheeJokeContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = TeeheeJokeParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (TeeheeJokeContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(TeeheeJokeContext $ctx, $op, $args): array
    {
