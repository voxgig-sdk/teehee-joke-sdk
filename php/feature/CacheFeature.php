...
class TeeheeJokeCacheFeature extends TeeheeJokeBaseFeature
{
    ...
    private function _through(TeeheeJokeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
