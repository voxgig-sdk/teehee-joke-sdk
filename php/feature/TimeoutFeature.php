...
// TeeheeJoke SDK timeout feature
...
class TeeheeJokeTimeoutFeature extends TeeheeJokeBaseFeature
{
    ...
    private function _with_timeout(TeeheeJokeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(TeeheeJokeContext $_ctx, float $ms): void
    {
        $client = $this->client;
