...
The PHP SDK for the TeeheeJoke API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Joke(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->TeeheeJoke(null)->load(
    ["id" => "test01"], null
);
