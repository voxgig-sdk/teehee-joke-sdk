...
The PHP SDK for the TeeheeJoke API — an entity-oriented client using PHP conventions.
...
```
php/
├── teeheejoke_sdk.php          -- Main SDK class
...
The main class (`teeheejoke_sdk.php`) exports the SDK class
