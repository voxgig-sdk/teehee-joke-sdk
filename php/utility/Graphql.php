...
// TeeheeJoke SDK utility: graphql
//
...
class TeeheeJokeGraphql
{
    ...
    // equivalent.
    public static function body(TeeheeJokeContext $ctx): mixed
    {
    ...
    public static function errors(TeeheeJokeContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
