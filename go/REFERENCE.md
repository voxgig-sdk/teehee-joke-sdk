# TeeheeJoke Golang SDK Reference

Complete API reference for the TeeheeJoke Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *TeeheeJokeSDK`
...
#### `Joke(data map[string]any) TeeheeJokeEntity`
