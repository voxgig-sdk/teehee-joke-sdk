...
// instead of `sdk.NewTeeheeJokeSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *TeeheeJokeSDK  { return NewTeeheeJokeSDK(nil) }
func Test() *TeeheeJokeSDK { return TestSDK(nil, nil) }
