...
func NewJokeEntity(client *core.TeeheeJokeSDK, entopts map[string]any) *JokeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *JokeEntity) GetName() string { return e.name }
...
func (e *JokeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *JokeEntity) Deleted() bool {
	return e.deleted
}


func (e *JokeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewJokeEntity(e.client, opts)
}

func (e *JokeEntity) Data(args ...any) any {
...
func (e *JokeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Joke; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *JokeEntity) DataTyped(data ...Joke) Joke {
	if len(data) > 0 {
		return typedFrom[Joke](e.Data(asMap(data[0])))
	}
	return typedFrom[Joke](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Joke (all fields
// optional at the wire level).
func (e *JokeEntity) MatchTyped(match ...Joke) Joke {
	if len(match) > 0 {
		return typedFrom[Joke](e.Match(asMap(match[0])))
	}
	return typedFrom[Joke](e.Match())
}
...
func (e *JokeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *JokeEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// JokeLoadMatch and returns an Joke. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *JokeEntity) LoadTyped(reqmatch JokeLoadMatch, ctrl map[string]any) (Joke, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Joke{}, err
	}
	return typedFrom[Joke](res), nil
}



func (e *JokeEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *JokeEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *JokeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *JokeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *JokeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
