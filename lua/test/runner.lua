...
function runner.env_override(m)
  local live = runner.getenv("TEEHEE_JOKE_TEST_LIVE")
  local override = runner.getenv("TEEHEE_JOKE_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("TEEHEE_JOKE_TEST_EXPLAIN")
