...
describe("JokeDirect", function()
  it("should direct-load-joke", function()
    local setup = joke_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-joke", setup.live and "live" or "unit")
...
function joke_direct_setup(mockres)
