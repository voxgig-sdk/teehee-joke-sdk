...
func registerSDKWords(r *eng.Registry, client *sdk.TeeheeJokeSDK) {
...
func runOp(client *sdk.TeeheeJokeSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
