...
AQL-driven CLI and REPL for the TeeheeJoke SDK. Positional arguments are
...
./teehee-joke-cli list joke
./teehee-joke-cli load 1 joke
./teehee-joke-cli load '{id:1}' joke
