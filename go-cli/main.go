// Command TeeheeJoke-cli is a CLI + REPL for the TeeheeJoke SDK,
...
const prompt = "teehee-joke"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "joke"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      TEEHEE_JOKE_APIKEY (api key), TEEHEE_JOKE_BASE (base url override)")
