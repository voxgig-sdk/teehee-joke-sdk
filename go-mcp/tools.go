...
type Args struct {
	Entity string         `json:"entity" jsonschema:"joke"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.TeeheeJokeSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "teehee-joke_list",
		Description: "List records from TeeheeJoke. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "teehee-joke_load",
		Description: "Load a single record from TeeheeJoke. " +
...
func runOp(client *sdk.TeeheeJokeSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.TeeheeJokeSDK, name string) (sdk.TeeheeJokeEntity, error) {
	switch strings.ToLower(name) {
	case "joke":
		return client.Joke(nil), nil
