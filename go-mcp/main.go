// Command TeeheeJoke-mcp is an MCP server exposing the TeeheeJoke
// SDK as MCP tools.
//
// Two tools are registered:
//
//	TeeheeJoke_list  — list records of an entity
//	TeeheeJoke_load  — load a single record of an entity
//
